...
function enqueue_bootstrap()
{
    ...
    // Enqueue Bootstrap JS (dependiendo de jQuery)
...
function pagoWompi($atts, $content = null)
{
    ...
    $signaturet = time();
    ?>
    <form method="POST" action="https://www.ens.org.co/wompi/informacionwompi.php" id="donationForm"
        style="background: #e7e5e5; border-radius: 5%; padding: 40px; margin-left: 7%;">
        ...
        <button type="button" style="border: 0px transparent; margin-top: 20px;" class="btn btn-primary" id="submitButton"
            onclick="validateAmount();">
            <img style="width: 15%; margin-right: 15px;"
                src="https://www.ens.org.co/wp-content/uploads/2024/07/photo_2024-07-16_09-04-08-removebg-preview-1.png">
            Quiero donar
        </button>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="d-flex justify-content-end m-4">
                        <button type="submit" class="btn btn-secondary">Realizar la donación</button>
                    </div>
                </div>
            </div>
        </div>
